  ...
  useEffect(() => {
    (async function () {
      ...
      if (!data) {
        ...
        setWeather(data);
        console.log(data);
        document.getElementById("cardbody").style.backgroundImage = `url('https://source.unsplash.com/1600x1900/?"${city}"')`;
        error.textContent = "";
        loading.textContent = "";
        setLoad(city);
      }
    ...
    <main className="m-3">
      <div className="row d-flex justify-content-center align-items-center">
        <div className="col-md-8">
          <div className="cardbody container h-100 p-3 rounded-3 text-light" id="cardbody">
            <h1 className="m-0 fw-bolder text-light cardname w-50 rounded-3">City: {load}</h1>
          </div>
        </div>
        <div className="col-md-4 d-flex justify-content-end mt-3 flex-end">
